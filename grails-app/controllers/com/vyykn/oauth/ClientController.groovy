...
class ClientController {
    ...
    def save(Client clientInstance) {
        ...
        clientInstance.clientId=params.clientId
        clientInstance.redirectUris=[params.redirectUris]
        clientInstance.authorizedGrantTypes= ['authorization_code', 'refresh_token', 'implicit', 'password', 'client_credentials']
        clientInstance.authorities= ['ROLE_CLIENT']
        clientInstance.scopes= ['read', 'write']
